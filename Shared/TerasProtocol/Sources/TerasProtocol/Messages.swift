...
public struct Hello: Codable, Equatable, Sendable {
    ...
    public init(pv: Int = Teras.protocolVersion, hostId: String, hostName: String, transport: Transport,
...
public struct HelloAck: Codable, Equatable, Sendable {
    ...
    public init(pv: Int = Teras.protocolVersion, deviceId: String, deviceName: String, platform: Platform,
