...
* Host gesture policy (v1): 1 finger = left mouse down/drag/up; 2‑finger drag → SCROLL is generated by the receiver, not the host. Long press = right click (receiver decides and sends POINTER with button=2).
