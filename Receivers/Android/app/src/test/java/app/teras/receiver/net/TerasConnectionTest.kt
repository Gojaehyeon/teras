...
import app.teras.receiver.store.InMemoryHostStore
 ...
 * only exist in [TerasConnection], not in the state machine.
 */
class TerasConnectionTest {
    private val sockets = mutableListOf<AutoCloseable>()
    private var connection: TerasConnection? = null
