...
import app.teras.receiver.net.PointerButton
import app.teras.receiver.net.PointerKind
import app.teras.receiver.net.ScrollPhase
import app.teras.receiver.net.TouchPhase
import app.teras.receiver.net.TouchPointer
import app.teras.receiver.net.TouchTool
import android.view.KeyEvent as AndroidKeyEvent

/**
 * Turns Android input into Teras input frames (PROTOCOL.md §6).
 *
